      ...
      <form action="" method="post" enctype="multipart/form-data">
         <div class="flex">
            ...
            <div class="inputBox">
               ...
               <input type="number" min="0" class="box" required max="9999999999" placeholder="Nhập giá sản phẩm"
            ...
            <div class="inputBox">
               <span>
                  Thông tin chi tiết sản phẩm (bắt buộc)</span>
               <textarea name="details" placeholder="thêm thông tin chi tiết sản phẩm" class="box" required
         ...
         if ($select_products->rowCount() > 0) {
            while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
               ...
               <div class="box">
                  ...
                  <div class="price" style="text-align: center"><span>
                        <?= $fetch_products['price']; ?>VNĐ
                     </span></div>
